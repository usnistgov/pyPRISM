...
# This is kind of gross, but I'm not sure how else to handle optional
# tests like this. If the Debyer module can't be imported, then we 
# simply block the TestCase from being imported. 
try:
    from pyPRISM.trajectory.Debyer import Debyer
except ImportError:
    print('Debyer extension not compiled. Skipping Debyer tests... ')
else:
