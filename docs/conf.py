...
sys.path.insert(0, os.path.abspath('../'))
try:
    from pyPRISM.version import __version__
    release = __version__.lstrip('v')  # Remove 'v' prefix if present
    version = release.split('-')[0]  # Get base version without git suffix
except ImportError:
